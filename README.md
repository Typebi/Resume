...
<link rel="icon" href="ProfileImage_32x32.png" sizes="32x32">
<link rel="icon" href="ProfileImage_192x192.png" sizes="192x192">
<link rel="icon" href="ProfileImage_96x96.png" sizes="96x96">
<link rel="icon" href="ProfileImage_16x16.png" sizes="16x16">
</head>
	...
	<div class="doc">
			...
			<ul>
				...
				<ul>
					<li>19.10. One week project 1
						<ul><li><a href=>&ltKeyboardO Colosseum&gt</a>, typing game made by Java</li>
		...
		<div>
			<h3>Featured Projects</h3><hr/>
				<ul>
					<h4 id=kboc>KeyboardO Colosseum <small></small><code>100% Java</code></h4>
					<p>Typing battle game</p> <img class=featured-project-rounded-img src="KBOC_Play.png">
				</ul>
		</div>
	</div>
</body>
